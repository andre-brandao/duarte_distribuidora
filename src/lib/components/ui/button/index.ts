...
const buttonVariants = tv({
	...
	variants: {
		variant: {
			...
			brenovar:
				'transition ease-in-out border border-gray-400 text-secondary-foreground shadow-sm hover:bg-yellow-400 bg-primary rounded-lg font-semibold bg-opacity-0',
			brenosubmit:
