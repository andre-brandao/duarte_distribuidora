...
<div class="">
	<div class="mb-5 mt-5 flex flex-col justify-between sm:flex-row">
		<div class="items-center gap-0">
			<h1 class="text-center text-4xl font-bold">Cardapio</h1>
		</div>
		<div class="mt-4 flex justify-center gap-2 sm:mt-0">
			<Input
				placeholder="Pesquisar produto..."
				class="col-span-2 h-10 w-full  py-1 md:h-auto"
				bind:value={search}
			/>
		</div>
	</div>

	<div class="sticky top-2 z-10 rounded-lg bg-primary">
		<div
